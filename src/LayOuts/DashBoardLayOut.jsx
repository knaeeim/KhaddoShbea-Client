...
import userProfile from "../assets/lotties/userProfile.json";
...
const DashBoardLayOut = () => {
    ...
    const dashBoardLink = (
        <div className="flex flex-col justify-between min-h-[calc(100vh-150px)] px-4">
            <div>
                <li>
                    <NavLink
                        to="/dashboard"
            ...
            <div className="bg-gray-300 py-2 px-2 rounded-lg shadow-md">
                <div className="dropdown dropdown-top flex items-center">
                    ...
                    <span className="ml-2 md:text-lg text-sm font-bold">
                        {user?.displayName}
                    </span>
                    <ul
                        tabIndex={0}
